...
func ExampleParse_errorChecking() {
	// Token from another example.  This token has a bad signature
	var tokenString = "eyJ0eXAiOiJoMjU2b25seSJ9.eyJmb28iOiJiYXIiLCJleHAiOjE1MDAwLCJpc3MiOiJ0ZXN0In0.wrongsig"
	// Load your secret key from a safe place and reuse it across multiple
	// calls. (Obviously don't use this example key for anything real.) If you
	// want to convert a passphrase to a key, use a suitable package like bcrypt
	// or scrypt.
